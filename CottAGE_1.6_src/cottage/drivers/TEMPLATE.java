...
public class TEMPLATE extends MAMEDriver implements Driver, MAMEConstants {
...
private boolean writemem() {
	MW_START();
	MW_ADD( 0x0000, 0x7fff, MWA_ROM );	/* 4000-7fff is written to during startup, probably leftover code */
	return true;
}
