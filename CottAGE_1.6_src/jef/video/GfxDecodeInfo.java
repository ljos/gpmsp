...
public class GfxDecodeInfo {
	...
	public boolean IS_FRAC(int offset) { return ((offset & 0x80000000)!=0); }
	public int FRAC_NUM(int offset) { return (offset >> 27) & 0x0F; }
	public int FRAC_DEN(int offset) { return (offset >> 23) & 0x0F; }
	public int FRAC_OFFSET(int offset) { return (offset & 0x007FFFFF); }
