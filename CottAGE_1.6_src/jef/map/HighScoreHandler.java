...
public class HighScoreHandler implements WriteHandler {
	...
	// select this value for blank_char if the scores are stored in nibbles
	// instead of bytes.
	...
	/**
	 * @param passThrough
	 *            The 'real' memory handler for this memory area
	 * @param m
	 *            Reference to the Machine
	 * @param memory
	 *            Reference to the memory
	 * @param blank_char
	 *            The byte value for a blank character (use CHAR_NIBBLES if
	 *            digits are stored in nibbles).
	 * @param zero_char
	 *            The byte value for a zero character
	 * @param initial_high_score
	 *            The initial high score at boot-up
	 * @param start_addr
	 *            The start address of the high score
	 * @param offset
	 *            The offset between bytes
	 * @param last_addr
	 *            The last address of the high score
	 * @param delay
	 *            A delay before high scores are calculated. Used to skip init
	 *            sequences like in pacman.
	 */
	public HighScoreHandler(WriteHandler passThrough, Machine m, int[] memory,
			int blank_char, int zero_char, int initial_high_score,
			int start_addr, int offset, int last_addr, int delay) {
		super();
