...
/** $ED prefix opcodes */
 private final void prefix_ED() {
	 ...
	 switch (instruction & 0xff) {
	  ...
	  case 0x43:	cycle-=20; ram.write16(ram.read16arg(PC),BC()); PC+=2; break;// LD (nn),BC
	  case 0x44:	cycle-=13; tmp1=A; A=0; A=subA_8(tmp1,A); break; 		// NEG
	  case 0x45:	cycle-=14; PC=ram.read16arg(SP); SP+=2; IFF0=IFF1; 		// RET N
					cycle = checkInterrupt(cycle); break;
	  case 0x46: 	cycle-=8; IM = 0; break; 				// IM 0
	  case 0x47:	cycle-=9; I = A; break;					// LD I,A

	  case 0x48:	cycle-=12; C=in(C,C); break;			// IN C,(C)		ok
	  case 0x49:	cycle-=12; out(C,D); break; 			// OUT (C),D	ok
	  case 0x4a:	cycle-=15; adcHL(BC()); break; 			// ADC HL,BC
	  case 0x4b:	cycle-=20; B=ram.read8(ram.read16arg(PC)+1); C=ram.read8(ram.read16arg(PC)); PC+=2; break; // LD BC,(nn)
	  case 0x4c:	cycle-=13; tmp1=A; A=0; A=subA_8(tmp1,A); break; 				// NEG
	  case 0x4d:	cycle-=14; PC=ram.read16arg(SP); SP+=2; break; 					// RETI
	  case 0x4e: 	cycle-=8; IM = 0; break; 				// IM 0
	  case 0x4f:	cycle-=9; R = A; R2 = A & 0x80; break;	// LD R,A

	  case 0x50:	cycle-=12; D=in(C,D); break;			// IN D,(C)		ok
	  case 0x51:	cycle-=12; out(C,D); break; 			// OUT (C),E
	  case 0x52:	cycle-=15; sbcHL(DE()); break; 			// SBC HL,DE	ok
	  case 0x53:	cycle-=20; ram.write16(ram.read16arg(PC),DE()); PC+=2; break;// LD (nn),DE
	  case 0x54:	cycle-=13; tmp1=A; A=0; A=subA_8(tmp1,A); break; 				// NEG
	  case 0x55:	cycle-=14; PC=ram.read16arg(SP); SP+=2; IFF0=IFF1; 				// RET N
					cycle = checkInterrupt(cycle);  break;
	  case 0x56: 	cycle-=8; IM = 1; break; 				// IM 1
	  case 0x57:	cycle-=9; A = I; break;					// LD A,I

	  case 0x58:	cycle-=12; E=in(C,E); break;			// IN E,(C)		ok
	  case 0x59:	cycle-=12; out(C,E); break; 			// OUT (C),E
	  case 0x5a:	cycle-=15; adcHL(DE()); break; 			// ADC HL,DE
	  case 0x5B:	cycle-=20; D=ram.read8(ram.read16arg(PC)+1); E=ram.read8(ram.read16arg(PC)); PC+=2; break; // LD DE,(nn)
	  case 0x5c:	cycle-=13; tmp1=A; A=0; A=subA_8(tmp1,A); break; 				// NEG
	  case 0x5d:	cycle-=14; PC=ram.read16arg(SP); SP+=2; break; 					// RETI
	  case 0x5e: 	cycle-=8; IM = 2; break; 				// IM 2
	  case 0x5f:	cycle-=9; A=R()&0x7f|R2; F = (F & CF) | SZ[A] | ( IFF1 ? 2 : 0 );break; // LD A,R

	  case 0x60:	cycle-=12; H=in(C,H); break;			// IN H,(C)		ok
	  case 0x61:	cycle-=12; out(C,H); break; 			// OUT (C),H
	  case 0x62:	cycle-=15; sbcHL(HL()); break; 			// SBC HL,HL	ok
	  case 0x63:	cycle-=20; ram.write16(ram.read16arg(PC),HL()); PC+=2; break;	// LD (nn),HL
	  case 0x64:	cycle-=13; tmp1=A; A=0; A=subA_8(tmp1,A); break; 				// NEG
	  case 0x65:	cycle-=14; PC=ram.read16arg(SP); SP+=2; IFF0=IFF1; 				// RET N
					cycle = checkInterrupt(cycle); break;
	  case 0x66: 	cycle-=8; IM = 0; break; 				// IM 0
	  case 0x67:	cycle-=18; A=rrd_A(A,H,L); break;		// RRD

	  case 0x68:	cycle-=12; L=in(C,L); break;			// IN L,(C)		ok
	  case 0x69:	cycle-=12; out(C,L); break; 			// OUT (C),L
	  case 0x6a:	cycle-=15; adcHL(HL()); break; 			// ADC HL,HL
	  case 0x6B:	cycle-=20; H=ram.read8(ram.read16arg(PC)+1); L=ram.read8(ram.read16arg(PC)); PC+=2; break; // LD HL,(nn)
	  case 0x6c:	cycle-=13; tmp1=A; A=0; A=subA_8(tmp1,A); break; 				// NEG
	  case 0x6d:	cycle-=14; PC=ram.read16arg(SP); SP+=2; break; 					// RETI
	  ...
	  case 0x73:	cycle-=20; ram.write16(ram.read16arg(PC),SP); PC+=2; break; 		// LD (nn),SP

	  case 0x78:	cycle-=12; A=in(C,A); break;			// IN A,(C)
	  case 0x79:	cycle-=11; out(C,A); break; 			// OUT (C),A
	  case 0x7a:	cycle-=15; adcHL(SP); break; 			// ADC HL,SP
	  case 0x7B:	cycle-=20; SP=ram.read16(ram.read16arg(PC)); PC+=2; break;			// LD SP,(nn)

	  case 0xa0:	cycle-=21; 								// LDI
					tmp1=DE(); tmp2=HL(); tmp3=BC(); ram.write8(tmp1,ram.read8(tmp2++)); tmp1=(tmp1+1)&0xffff; tmp3=(tmp3-1)&0xffff;
	  ...
	  case 0xb0: 	cycle=cycle-(5+16*(BC())); tmp1=DE(); tmp2=HL();	// LDIR - ok
					for (int n=(BC()); n>0; n--) {
						ram.write8(tmp1,ram.read8(tmp2)); tmp1=(tmp1+1)&0xffff; tmp2=(tmp2+1)&0xffff;
					}
					E=tmp1&0xff; D=tmp1>>8; B=C=0; L=tmp2&0xff; H=tmp2>>8; F&=0xe9; break;
	  case 0xb1:	tmp2 = F&1; tmp1=BC(); tmp3=HL(); 						// CPIR - ok
					cycle-=4; cpA_8(ram.read8(tmp3),A); tmp3++; tmp1--;
...
/** $CB prefix opcodes */
 private final void prefix_BC() {
	 ...
	 switch (instruction&0xff) {
		 ...
		 case 0x06: cycle-=15; ram.write8(HL(),rlc(HLi())); break;
		 ...
		 case 0x0e: cycle-=15; ram.write8(HL(),rrc(HLi())); break;
		 ...
		 case 0x16:	cycle-=15; ram.write8((HL()), rl(HLi())); break;
		 ...
		 case 0x1E:	cycle-=15; ram.write8((HL()), rr(HLi())); break;
		 ...
		 case 0x26:	cycle-=12; ram.write8((HL()), sla(HLi())); break;
		 ...
		 case 0x2e:	cycle-=12; ram.write8((HL()), sra(HLi())); break;
		 ...
		 case 0x36:	cycle-=12; ram.write8((HL()), sll(HLi())); break;
		 ...
		 case 0x3e: cycle-=12; ram.write8((HL()), srl(HLi())); break;
		 ...
		 case 0x86: cycle-=12; ram.write8(HL(),res(0,HLi())); break;
		 ...
		 case 0x8e: cycle-=12; ram.write8(HL(),res(1,HLi())); break;
		 ...
		 case 0x96: cycle-=12; ram.write8(HL(),res(2,HLi())); break;
		 ...
		 case 0x9e: cycle-=12; ram.write8(HL(),res(3,HLi())); break;
		 ...
		 case 0xa6: cycle-=12; ram.write8(HL(),res(4,HLi())); break;
		 ...
		 case 0xae: cycle-=12; ram.write8(HL(),res(5,HLi())); break;
		 ...
		 case 0xb6: cycle-=12; ram.write8(HL(),res(6,HLi())); break;
		 ...
		 case 0xbe: cycle-=12; ram.write8(HL(),res(7,HLi())); break;
		 ...
		 case 0xc6: cycle-=12; ram.write8(HL(),set(0,HLi())); break;
		 ...
		 case 0xce: cycle-=12; ram.write8(HL(),set(1,HLi())); break;
		 ...
		 case 0xd6: cycle-=12; ram.write8(HL(),set(2,HLi())); break;
		 ...
		 case 0xde: cycle-=12; ram.write8(HL(),set(3,HLi())); break;
		 ...
		 case 0xe6: cycle-=12; ram.write8(HL(),set(4,HLi())); break;
		 ...
		 case 0xee: cycle-=12; ram.write8(HL(),set(5,HLi())); break;
		 ...
		 case 0xf6: cycle-=12; ram.write8(HL(),set(6,HLi())); break;
		 ...
		 case 0xfe: cycle-=12; ram.write8(HL(),set(7,HLi())); break;
...
/** $DD and $FD prefix opcodes (index instructions) */
 private final int execXY(int XY) {
	...
	switch (instruction&0xff) {
		...
		case 0x21 :	cycle-=14; XY=ram.read16arg(PC); PC+=2; break; 				// LD XY,nn		ok
		case 0x22 :	cycle-=20; ram.write16(ram.read16arg(PC),XY); PC+=2; break; 	// LD (nn),XY	ok
		case 0x23 :	cycle-=10; XY=(XY+1)&0xffff; break; // INC XY		ok
		case 0x24 :
		case 0x25 : error(instruction, PPC); break; // Not implemented
		case 0x26 : cycle-=11; XY=(XY&0x00ff)|(ram.read8arg(PC++)<<8); break;		// LD HXY,n		ok
		case 0x27 :
		case 0x28 : error(instruction, PPC); break; // Not implemented
		case 0x29 :	cycle-=15; XY=add16(XY,XY); break;	// ADD XY,XY		ok
		case 0x2a :	cycle-=20; XY=ram.read16(ram.read16arg(PC)); PC+=2; break; 	// LD XY,(nn)	ok
		...
		case 0x2e : cycle-=11; XY=(XY&0xff00)|ram.read8arg(PC++); break;
		case 0x2f :
		case 0x30 :
		case 0x31 :
		case 0x32 :
		case 0x33 : error(instruction, PPC); break; // Not implemented
		case 0x34 :	cycle-=15; ram.write8(IXYd,inc8(ram.read8(IXYd))); PC++; break; // INC (XY+d)	ok
		case 0x35 :	cycle-=15; ram.write8(IXYd,dec8(ram.read8(IXYd))); PC++; break; // DEC (XY+d)	ok
		case 0x36 :	cycle-=19; ram.write8(IXYd,ram.read8arg(PC+1)); PC+=2; break; 	// LD (XY+d),n
		case 0x37 :
		...
		case 0x46 :	cycle-=11; B=ram.read8(IXYd); PC++; break; 						// LD B,(XY+d)	ok
		case 0x47 :
		case 0x48 :
		case 0x49 :
		case 0x4a :
		...
		case 0x4e :	cycle-=11; C=ram.read8(IXYd); PC++; break; 					// LD C,(XY+d)	ok
		case 0x4f :
		case 0x50 :
		case 0x51 :
		case 0x52 :
		...
		case 0x56 :	cycle-=11; D=ram.read8(IXYd); PC++; break; 					// LD D,(XY+d)	ok
		case 0x57 :
		case 0x58 :
		case 0x59 :
		case 0x5a :
		...
		case 0x5e :	cycle-=11; E=ram.read8(IXYd); PC++; break; 					// LD E,(XY+d)	ok
		...
		case 0x66 :	cycle-=11; H=ram.read8(IXYd); PC++; break; 					// LD H,(XY+d)	ok
		...
		case 0x6e :	cycle-=11; L=ram.read8(IXYd); PC++; break; 					// LD L,(XY+d)	ok
		case 0x6f : cycle-=11; XY = (XY&0xff00) | A; break;
		case 0x70 :	cycle-=11; ram.write8(IXYd,B); PC++; break; 					// LD (XY+d),B	ok
		case 0x71 :	cycle-=11; ram.write8(IXYd,C); PC++; break; 					// LD (XY+d),C	ok
		case 0x72 :	cycle-=11; ram.write8(IXYd,D); PC++; break; 					// LD (XY+d),D	ok
		case 0x73 :	cycle-=11; ram.write8(IXYd,E); PC++; break; 					// LD (XY+d),E	ok
		case 0x74 :	cycle-=11; ram.write8(IXYd,H); PC++; break; 					// LD (XY+d),H	ok
		case 0x75 :	cycle-=11; ram.write8(IXYd,L); PC++; break; 					// LD (XY+d),L	ok
		case 0x77 :	cycle-=11; ram.write8(IXYd,A); PC++; break; 					// LD (XY+d),A	ok
		case 0x78 :
		case 0x79 :
		case 0x7a :
		...
		case 0x7e :	cycle-=11; A=ram.read8(IXYd); PC++; break; 					// LD A,(XY+d)	ok
		case 0x7f :
		case 0x80 :
		case 0x81 :
		case 0x82 :
		...
		case 0x86 :	cycle-=11; A=addA_8(ram.read8(IXYd),A); PC++; break; 			// ADD A,(XY+d)	ok
		case 0x87 :
		case 0x88 :
		case 0x89 :
		case 0x8a :
		...
		case 0x8e :	cycle-= 11; A=adcA_8(ram.read8(IXYd),A); PC++; break; 		// ADC A,(XY+d)	ok
		case 0x8f :
		case 0x90 :
		case 0x91 :
		case 0x92 :
		...
		case 0x96 :	cycle-= 11; A=subA_8(ram.read8(IXYd),A); PC++; break; 		// SUB A,(XY+d)	ok
		case 0x97 :
		case 0x98 :
		case 0x99 :
		case 0x9a :
		...
		case 0x9e :	cycle-= 11; A=sbcA_8(ram.read8(IXYd),A); PC++; break; 		// SBC A,(XY+d)	ok
		case 0x9f :
		case 0xa0 :
		case 0xa1 :
		case 0xa2 :
		...
		case 0xa6 :	cycle-=11; A=andA(ram.read8(IXYd),A); PC++; break; 			// AND (XY+d)	ok
		case 0xa7 :
		case 0xa8 :
		case 0xa9 :
		case 0xaa :
		...
		case 0xae :	cycle-=11; A=xorA(ram.read8(IXYd),A); PC++; break; 			// XOR (XY+d)	ok
		case 0xaf :
		case 0xb0 :
		case 0xb1 :
		case 0xb2 :
		...
		case 0xb6 :	cycle-=11; A=orA(ram.read8(IXYd),A); PC++; break; 			// OR (XY+d)	ok
		case 0xb7 :
		case 0xb8 :
		case 0xb9 :
		case 0xba :
		...
		case 0xbe :	cycle-= 11; cpA_8(ram.read8(IXYd),A); PC++; break; 			// CP (XY+d)	ok
		case 0xcb :	//---------------------------Second table-----------------------------
					IXYd = XY + sign(ram.read8arg(PC++));
					instruction = (instruction << 8) + ram.read8(PC++);
					switch (instruction&0xff) {
						case 0x06: cycle-=15; ram.write8(IXYd, rlc(ram.read8(IXYd))); break; // RLC (IXYd)	ok
						case 0x0E: cycle-=15; ram.write8(IXYd, rrc(ram.read8(IXYd))); break; // RRC (IXYd)	ok
						case 0x16: cycle-=12; ram.write8(IXYd,  rl(ram.read8(IXYd))); break; // RL (IXYd)		ok
						case 0x1E: cycle-=12; ram.write8(IXYd,  rr(ram.read8(IXYd))); break; // RR (IXYd)		ok
						case 0x26: cycle-=12; ram.write8(IXYd, sla(ram.read8(IXYd))); break; // SLA (IXYd)	ok
						case 0x2e: cycle-=12; ram.write8(IXYd, sra(ram.read8(IXYd))); break; // SRA (IXYd)	ok
						case 0x36: cycle-=12; ram.write8(IXYd, sll(ram.read8(IXYd))); break; // SLL (IXYd)	ok
						case 0x3e: cycle-=12; ram.write8(IXYd, srl(ram.read8(IXYd))); break; // SRL (IXYd)	ok
						case 0x40:
						case 0x41:
						case 0x42:
						case 0x43:
						...
						case 0x45:
						case 0x46:
						case 0x47: cycle-=12; bit(0,ram.read8(IXYd)); break;
						case 0x48:
						case 0x49:
						case 0x4a:
						case 0x4b:
						...
						case 0x4d:
						case 0x4e:
						case 0x4f: cycle-=12; bit(1,ram.read8(IXYd)); break;
						case 0x50:
						case 0x51:
						case 0x52:
						case 0x53:
						...
						case 0x55:
						case 0x56:
						case 0x57: cycle-=12; bit(2,ram.read8(IXYd)); break;
						case 0x58:
						case 0x59:
						case 0x5a:
						case 0x5b:
						...
						case 0x5d:
						case 0x5e:
						case 0x5f: cycle-=12; bit(3,ram.read8(IXYd)); break;
						case 0x60:
						case 0x61:
						case 0x62:
						case 0x63:
						...
						case 0x65:
						case 0x66:
						case 0x67: cycle-=12; bit(4,ram.read8(IXYd)); break;
						case 0x68:
						case 0x69:
						case 0x6a:
						case 0x6b:
						...
						case 0x6d:
						case 0x6e:
						case 0x6f: cycle-=12; bit(5,ram.read8(IXYd)); break;
						case 0x70:
						case 0x71:
						case 0x72:
						case 0x73:
						...
						case 0x75:
						case 0x76:
						case 0x77: cycle-=12; bit(6,ram.read8(IXYd)); break;
						case 0x78:
						case 0x79:
						case 0x7a:
						case 0x7b:
						...
						case 0x7d:
						case 0x7e:
						case 0x7f: cycle-=12; bit(7,ram.read8(IXYd)); break;
						case 0x86: cycle-=12; ram.write8(IXYd,res(0,ram.read8(IXYd))); break;
						case 0x8e: cycle-=12; ram.write8(IXYd,res(1,ram.read8(IXYd))); break;
						case 0x96: cycle-=12; ram.write8(IXYd,res(2,ram.read8(IXYd))); break;
						case 0x9e: cycle-=12; ram.write8(IXYd,res(3,ram.read8(IXYd))); break;
						case 0xa6: cycle-=12; ram.write8(IXYd,res(4,ram.read8(IXYd))); break;
						case 0xae: cycle-=12; ram.write8(IXYd,res(5,ram.read8(IXYd))); break;
						case 0xb6: cycle-=12; ram.write8(IXYd,res(6,ram.read8(IXYd))); break;
						case 0xbe: cycle-=12; ram.write8(IXYd,res(7,ram.read8(IXYd))); break;
						case 0xc6: cycle-=12; ram.write8(IXYd,set(0,ram.read8(IXYd))); break;
						case 0xce: cycle-=12; ram.write8(IXYd,set(1,ram.read8(IXYd))); break;
						case 0xd6: cycle-=12; ram.write8(IXYd,set(2,ram.read8(IXYd))); break;
						case 0xde: cycle-=12; ram.write8(IXYd,set(3,ram.read8(IXYd))); break;
						case 0xe6: cycle-=12; ram.write8(IXYd,set(4,ram.read8(IXYd))); break;
						case 0xee: cycle-=12; ram.write8(IXYd,set(5,ram.read8(IXYd))); break;
						//case 0xf4: cycle-=12; ram.write8(IXYd,set(6,ram.read8(IXYd))); // undocumented
						//						H=ram.read8(IXYd); break;
						case 0xf6: cycle-=12; ram.write8(IXYd,set(6,ram.read8(IXYd))); break;
						case 0xfe: cycle-=12; ram.write8(IXYd,set(7,ram.read8(IXYd))); break;

						default: error(instruction, PPC); break; // Not implemented
					}
					break;
		case 0xe1:	cycle-=14; XY=pop(); break; 					// POP XY	ok
		case 0xe3:	cycle-=23; tmp1=ram.read16(SP);ram.write16(SP,XY);XY=tmp1; break; 	// EX (SP),XY	ok
		case 0xe5:	cycle-=14; ram.write16fast(SP-2,XY); SP-=2; break; 					// PUSH XY	ok
...
/** CP A,n */
 private final void cp_n() {
	 cycle -= 7; cpA_8(ram.read8arg(PC++),A);
 }
 ...
 private int checkInterrupt(int cycle) {
	if (NMI || (IFF0 && IRQ)) {
	   ...
	   if (IFF0 && IRQ) {	// Take interrupt if enabled
		   //if (!goingToirq) {
				//if (!debugDisabled) { log("...CPUZ80 takes interrupt using interrupt mode "+Integer.toString(IM)); }
				state_HALT = false;
 ...
 private void debug(int instruction, int PPC, int A, int F, int B, int C, int D, int E,
	...
	if (debugEnabled) {
		...
		String dataLog=Integer.toHexString(PPC)+" : "
			...
			+ Integer.toHexString(ram.read8(PPC+1))+","
			+ Integer.toHexString(ram.read8(PPC+2))+","
			+ Integer.toHexString(ram.read8(PPC+3))+"    \t";
		if (instruction < 256) {
